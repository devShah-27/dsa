...
// greater than or equal to x (lower bound).
//
...
//
// Idea:
// Traverse the array from left to right and return
...
int main()
{
    ...
    int foundIndex = lowerBound(nums, target);

    cout << "\n"
         << target << "'s lower bound found at " << foundIndex;
